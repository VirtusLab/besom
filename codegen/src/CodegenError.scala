...
object GeneralCodegenException {
  ...
  def unapply(e: GeneralCodegenException): Option[(String, Throwable)] = Some((e.getMessage, e.getCause))
}
...
object PulumiTypeCoordinatesError {
  ...
  def unapply(e: PulumiTypeCoordinatesError): Option[(String, Throwable)] = Some((e.getMessage, e.getCause))
}
...
object ClassCoordinatesError {
  ...
  def unapply(e: ClassCoordinatesError): Option[(String, Throwable)] = Some((e.getMessage, e.getCause))
}
...
object TypeMapperError {
  ...
  def unapply(e: TypeMapperError): Option[(String, Throwable)] = Some((e.getMessage, e.getCause))
}
