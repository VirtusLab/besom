...
case class PulumiPackage(name: String, language: Language, meta: Meta, types: Map[String, TypeDefinition], provider: ResourceDefinition, resources: Map[String, ResourceDefinition])
