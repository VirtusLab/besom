...
object k8s:
  ...
  //       NotProvided
  //   )(using Context): LabelSelectorArgs = new LabelSelectorArgs(matchLabels.asOutputMap)
  ...
  object ManagedFieldsEntryArgs:
    def apply(
      ...
      fieldsV1: ujson.Value | Output[ujson.Value] | NotProvided = NotProvided,
  ...
  case class ContainerPortArgs(containerPort: Output[Int]) derives ArgsEncoder
