...
#### Core API
* [`withArgs` (copy) method added to args companion objects for all Args classes](https://github.com/VirtusLab/besom/pull/522). This allows for Args reuse between similar resources.
* [StackReferences can now be typed statically](https://github.com/VirtusLab/besom/pull/528) by just providing the target type to which exports are to be loaded.
* The `(using Context)` clause has been dropped from many APIs due to the introduction of built-in reader monad into the `Output` monad's internals that passes `Context` internally. It is now only required where `Context` is used to establish resource parenthood relationships or where free functions require access to the data related to the current stack.
* [Fixed codegen issue](https://github.com/VirtusLab/besom/pull/526) where `"plain"` input parameters were generated as `Input`s instead of raw arguments. This fixes a whole category of smaller issues with providers.
* [Code-generated output classes](https://github.com/VirtusLab/besom/pull/524) now use `Output` types for all fields. This ensures that deserialization errors are isolated to individual fields and that field secrecy is handled with finer granularity.
* All public APIs [now take `Iterable[A]` instead of `List[A]`](https://github.com/VirtusLab/besom/pull/529). This allows greater flexibility of the user API - no more `.toList`!
* [Resource aliases](https://www.pulumi.com/docs/concepts/options/aliases/) are now [implemented](https://github.com/VirtusLab/besom/pull/532)!
* [Codegen now supports hotfixes](https://github.com/VirtusLab/besom/pull/558) allowing usage of many previously blocked packages.
...
#### Kubernetes provider
* Added Custom Resource and Custom Resource Patch support [in Kubernetes provider](https://github.com/VirtusLab/besom/pull/531) via overlays mechanism.
* We now support generation of resource classes from Kubernetes Custom Resource Definitions via [command line tool crd2besom](https://github.com/VirtusLab/besom/pull/534) _(experimental)_.

#### New examples:
  * [GCP Functions](https://github.com/VirtusLab/besom/tree/main/examples/gcp-functions)
  * [GCP Instance + Nginx](https://github.com/VirtusLab/besom/tree/main/examples/gcp-instance-nginx)
  * [Google Firestore](https://github.com/VirtusLab/besom/tree/main/examples/gcp-firebase)
  * [Google Cloud BigQuery](https://github.com/VirtusLab/besom/tree/main/examples/gcp-big-query)
  * [Azure ACI](https://github.com/VirtusLab/besom/tree/main/examples/azure-aci)
  * [Kubernetes + Keycloak](https://github.com/VirtusLab/besom/tree/main/examples/kubernetes-keycloak)
  * [Azure CosmosDB + LogicApp](https://github.com/VirtusLab/besom/tree/main/examples/azure-cosmosdb-logicapp)
  * [ETL pipeline with Amazon Redshift + AWS Glue](https://github.com/VirtusLab/besom/tree/main/examples/aws-redshift-glue-etl)
  * [Azure Synapse Workspace and Pools](https://github.com/VirtusLab/besom/tree/main/examples/azure-synapse)
  * [Azure web app with Private Endpoint and VNet injection](https://github.com/VirtusLab/besom/tree/main/examples/azure-webapp-privateendpoint-vnet-injection)

**Full Changelog**: https://github.com/VirtusLab/besom/compare/v0.3.2...v0.5.0

#### About Besom 0.4.0

Besom 0.4.0 was released in March of 2025 but, unfortunately, it did incorporate a significant correctness bug that impacted any user code that depended on the Component API. This issue was present in both Core SDK _and_ all packages generated by codegen of the 0.4.0 release. As the bug was found in the late smoke testing procedure of the release, most of the provider packages were already published to Maven Central. The release on Github was not published at the time and therefore the decision was made to scrap the whole release, not announce it, treat is as dead-on-arrival and to patch both Core SDK and Codegen and re-release everything once more.
