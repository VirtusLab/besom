...
3. **Install Scala Language Plugin in Pulumi**:
    ...
    ```bash
    pulumi plugin install language scala @BESOM_VERSION@ --server github://api.github.com/VirtusLab/besom
    ```
...
4. **Create a new project**:
   ...
   You can get started with the `pulumi new` command:
    ...
    ```
    ```bash
    pulumi new https://github.com/VirtusLab/besom/tree/v@BESOM_VERSION@/templates/aws
    ```
