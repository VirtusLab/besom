...
object SourcePosition extends scalapb.GeneratedMessageCompanion[pulumirpc.source.SourcePosition] {
  ...
  implicit class SourcePositionLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.source.SourcePosition]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.source.SourcePosition](_l) {
