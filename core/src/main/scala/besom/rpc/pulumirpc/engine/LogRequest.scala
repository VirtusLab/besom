...
object LogRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.engine.LogRequest] {
  ...
  implicit class LogRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.engine.LogRequest]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.engine.LogRequest](_l) {
