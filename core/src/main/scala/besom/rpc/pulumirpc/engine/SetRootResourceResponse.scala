...
object SetRootResourceResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.engine.SetRootResourceResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = EngineProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = EngineProto.scalaDescriptor.messages(4)
  ...
  implicit class SetRootResourceResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.engine.SetRootResourceResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.engine.SetRootResourceResponse](_l) {
  }
  def of(
