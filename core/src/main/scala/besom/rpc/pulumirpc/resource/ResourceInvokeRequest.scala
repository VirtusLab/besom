...
object ResourceInvokeRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.ResourceInvokeRequest] {
  ...
  object PluginChecksumsEntry extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.ResourceInvokeRequest.PluginChecksumsEntry] {
    ...
    implicit class PluginChecksumsEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.ResourceInvokeRequest.PluginChecksumsEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.resource.ResourceInvokeRequest.PluginChecksumsEntry](_l) {
