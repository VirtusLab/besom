...
object RegisterResourceRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceRequest] {
  ...
  object PropertyDependencies extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceRequest.PropertyDependencies] {
    ...
    implicit class PropertyDependenciesLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceRequest.PropertyDependencies]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.resource.RegisterResourceRequest.PropertyDependencies](_l) {
  ...
  object CustomTimeouts extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceRequest.CustomTimeouts] {
    ...
    implicit class CustomTimeoutsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceRequest.CustomTimeouts]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.resource.RegisterResourceRequest.CustomTimeouts](_l) {
  ...
  object ProvidersEntry extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceRequest.ProvidersEntry] {
    ...
    implicit class ProvidersEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceRequest.ProvidersEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.resource.RegisterResourceRequest.ProvidersEntry](_l) {
      def key: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.key)((c_, f_) => c_.copy(key = f_))
