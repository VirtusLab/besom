...
object GetSchemaResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.GetSchemaResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ProviderProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ProviderProto.scalaDescriptor.messages(1)
  ...
  implicit class GetSchemaResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.GetSchemaResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.provider.GetSchemaResponse](_l) {
