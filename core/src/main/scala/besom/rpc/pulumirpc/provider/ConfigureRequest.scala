...
object ConfigureRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.ConfigureRequest] {
  ...
  object VariablesEntry extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.ConfigureRequest.VariablesEntry] {
    ...
    implicit class VariablesEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.ConfigureRequest.VariablesEntry]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, pulumirpc.provider.ConfigureRequest.VariablesEntry](_l) {
