...
final case class InstallDependenciesRequest(
    ...
    useLanguageVersionTools: _root_.scala.Boolean = false,
    ...
    private def __computeSerializedSize(): _root_.scala.Int = {
      ...
      {
        val __value = useLanguageVersionTools
        if (__value != false) {
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = useLanguageVersionTools
        if (__v != false) {
    ...
    def withUseLanguageVersionTools(__v: _root_.scala.Boolean): InstallDependenciesRequest = copy(useLanguageVersionTools = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): _root_.scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 3 => info.orNull
        case 4 => {
          val __t = useLanguageVersionTools
          if (__t != false) __t else null
        }
      }
    }
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PBoolean(useLanguageVersionTools)
      }
    }
...
object InstallDependenciesRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.language.InstallDependenciesRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): pulumirpc.language.InstallDependenciesRequest = {
    ...
    var __useLanguageVersionTools: _root_.scala.Boolean = false
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 32 =>
          __useLanguageVersionTools = _input__.readBool()
        case tag =>
    ...
    pulumirpc.language.InstallDependenciesRequest(
        ...
        info = __info,
        useLanguageVersionTools = __useLanguageVersionTools,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.language.InstallDependenciesRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pulumirpc.language.InstallDependenciesRequest(
        ...
        useLanguageVersionTools = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Boolean]).getOrElse(false)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.language.LanguageProto.javaDescriptor.getMessageTypes().get(10)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.language.LanguageProto.scalaDescriptor.messages(10)
  ...
  implicit class InstallDependenciesRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.language.InstallDependenciesRequest]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.language.InstallDependenciesRequest](_l) {
    ...
    def useLanguageVersionTools: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.useLanguageVersionTools)((c_, f_) => c_.copy(useLanguageVersionTools = f_))
  }
  final val DIRECTORY_FIELD_NUMBER = 1
  final val IS_TERMINAL_FIELD_NUMBER = 2
  final val INFO_FIELD_NUMBER = 3
  final val USE_LANGUAGE_VERSION_TOOLS_FIELD_NUMBER = 4
  def of(
    ...
    useLanguageVersionTools: _root_.scala.Boolean
