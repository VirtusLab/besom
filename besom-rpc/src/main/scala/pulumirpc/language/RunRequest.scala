...
final case class RunRequest(
    ...
    attachDebugger: _root_.scala.Boolean = false,
    ...
    def withLoaderTarget(__v: _root_.scala.Predef.String): RunRequest = copy(loaderTarget = __v)
    def withAttachDebugger(__v: _root_.scala.Boolean): RunRequest = copy(attachDebugger = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 15 => _root_.scalapb.descriptors.PString(loaderTarget)
        case 16 => _root_.scalapb.descriptors.PBoolean(attachDebugger)
      }
    }
...
object RunRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.language.RunRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): pulumirpc.language.RunRequest = {
    ...
    var __attachDebugger: _root_.scala.Boolean = false
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 128 =>
          __attachDebugger = _input__.readBool()
        case tag =>
    ...
    pulumirpc.language.RunRequest(
        ...
        attachDebugger = __attachDebugger,
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.language.RunRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pulumirpc.language.RunRequest(
        ...
        loaderTarget = __fieldsMap.get(scalaDescriptor.findFieldByNumber(15).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        attachDebugger = __fieldsMap.get(scalaDescriptor.findFieldByNumber(16).get).map(_.as[_root_.scala.Boolean]).getOrElse(false)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.language.LanguageProto.javaDescriptor.getMessageTypes().get(8)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.language.LanguageProto.scalaDescriptor.messages(8)
  ...
  implicit class RunRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.language.RunRequest]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.language.RunRequest](_l) {
    ...
    def attachDebugger: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Boolean] = field(_.attachDebugger)((c_, f_) => c_.copy(attachDebugger = f_))
  }
  ...
  final val LOADER_TARGET_FIELD_NUMBER = 15
  final val ATTACH_DEBUGGER_FIELD_NUMBER = 16
  @transient
  ...
  def of(
    ...
    loaderTarget: _root_.scala.Predef.String,
    attachDebugger: _root_.scala.Boolean
