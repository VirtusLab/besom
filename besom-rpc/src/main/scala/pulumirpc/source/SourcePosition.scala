...
object SourcePosition extends scalapb.GeneratedMessageCompanion[pulumirpc.source.SourcePosition] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.source.SourceProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.source.SourceProto.scalaDescriptor.messages(0)
