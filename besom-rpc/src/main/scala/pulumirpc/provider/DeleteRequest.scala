...
final case class DeleteRequest(
    ...
    def withName(__v: _root_.scala.Predef.String): DeleteRequest = copy(name = __v)
    def withType(__v: _root_.scala.Predef.String): DeleteRequest = copy(`type` = __v)
...
object DeleteRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.DeleteRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(23)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(23)
  ...
  implicit class DeleteRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.DeleteRequest]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.provider.DeleteRequest](_l) {
