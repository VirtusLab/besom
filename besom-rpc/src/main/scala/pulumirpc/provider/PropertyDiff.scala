...
object PropertyDiff extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.PropertyDiff] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(15)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(15)
  ...
  implicit class PropertyDiffLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.PropertyDiff]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.provider.PropertyDiff](_l) {
