...
final case class DiffRequest(
    ...
    def withName(__v: _root_.scala.Predef.String): DiffRequest = copy(name = __v)
    def withType(__v: _root_.scala.Predef.String): DiffRequest = copy(`type` = __v)
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.provider.DiffRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pulumirpc.provider.DiffRequest(
        ...
        `type` = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(14)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(14)
