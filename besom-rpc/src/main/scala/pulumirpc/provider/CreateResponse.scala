...
object CreateResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.CreateResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(18)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(18)
  ...
  implicit class CreateResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.CreateResponse]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.provider.CreateResponse](_l) {
