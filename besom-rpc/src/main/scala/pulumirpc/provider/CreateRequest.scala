...
final case class CreateRequest(
    ...
    def withName(__v: _root_.scala.Predef.String): CreateRequest = copy(name = __v)
    def withType(__v: _root_.scala.Predef.String): CreateRequest = copy(`type` = __v)
...
object CreateRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.CreateRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(17)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(17)
