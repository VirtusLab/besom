...
final case class UpdateRequest(
    ...
    def withName(__v: _root_.scala.Predef.String): UpdateRequest = copy(name = __v)
    def withType(__v: _root_.scala.Predef.String): UpdateRequest = copy(`type` = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 9 => _root_.scalapb.descriptors.PString(name)
        case 10 => _root_.scalapb.descriptors.PString(`type`)
      }
    }
...
object UpdateRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.UpdateRequest] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.provider.UpdateRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pulumirpc.provider.UpdateRequest(
        ...
        name = __fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        `type` = __fieldsMap.get(scalaDescriptor.findFieldByNumber(10).get).map(_.as[_root_.scala.Predef.String]).getOrElse("")
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(21)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(21)
  ...
  implicit class UpdateRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.UpdateRequest]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.provider.UpdateRequest](_l) {
