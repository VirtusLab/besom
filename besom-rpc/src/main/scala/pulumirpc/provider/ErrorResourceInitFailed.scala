...
object ErrorResourceInitFailed extends scalapb.GeneratedMessageCompanion[pulumirpc.provider.ErrorResourceInitFailed] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.provider.ProviderProto.javaDescriptor.getMessageTypes().get(26)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.provider.ProviderProto.scalaDescriptor.messages(26)
  ...
  implicit class ErrorResourceInitFailedLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.provider.ErrorResourceInitFailed]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.provider.ErrorResourceInitFailed](_l) {
