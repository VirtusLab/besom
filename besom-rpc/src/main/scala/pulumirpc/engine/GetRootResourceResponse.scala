...
object GetRootResourceResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.engine.GetRootResourceResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.engine.EngineProto.javaDescriptor.getMessageTypes().get(2)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.engine.EngineProto.scalaDescriptor.messages(2)
  ...
  implicit class GetRootResourceResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.engine.GetRootResourceResponse]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.engine.GetRootResourceResponse](_l) {
