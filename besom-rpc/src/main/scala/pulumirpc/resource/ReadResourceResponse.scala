...
/** ReadResourceResponse contains the result of reading a resource's state.
  ...
  */
@SerialVersionUID(0L)
final case class ReadResourceResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ReadResourceResponse] {
    @transient
    ...
    def withUrn(__v: _root_.scala.Predef.String): ReadResourceResponse = copy(urn = __v)
    ...
    def clearProperties: ReadResourceResponse = copy(properties = _root_.scala.None)
    def withProperties(__v: com.google.protobuf.struct.Struct): ReadResourceResponse = copy(properties = Option(__v))
    ...
    def companion: pulumirpc.resource.ReadResourceResponse.type = pulumirpc.resource.ReadResourceResponse
    // @@protoc_insertion_point(GeneratedMessage[pulumirpc.ReadResourceResponse])
}

object ReadResourceResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.ReadResourceResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[pulumirpc.resource.ReadResourceResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): pulumirpc.resource.ReadResourceResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.resource.ReadResourceResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.resource.ResourceProto.javaDescriptor.getMessageTypes().get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.resource.ResourceProto.scalaDescriptor.messages(3)
  ...
  lazy val defaultInstance = pulumirpc.resource.ReadResourceResponse(
    urn = "",
    properties = _root_.scala.None
  )
  implicit class ReadResourceResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.ReadResourceResponse]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.ReadResourceResponse](_l) {
  ...
  ): _root_.pulumirpc.resource.ReadResourceResponse = _root_.pulumirpc.resource.ReadResourceResponse(
    urn,
    properties
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[pulumirpc.ReadResourceResponse])
}
