...
object RegisterResourceResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceResponse] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.resource.ResourceProto.javaDescriptor.getMessageTypes().get(5)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.resource.ResourceProto.scalaDescriptor.messages(5)
  ...
  object PropertyDependencies extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceResponse.PropertyDependencies] {
    ...
    implicit class PropertyDependenciesLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceResponse.PropertyDependencies]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.RegisterResourceResponse.PropertyDependencies](_l) {
  ...
  object PropertyDependenciesEntry extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceResponse.PropertyDependenciesEntry] {
    ...
    implicit class PropertyDependenciesEntryLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceResponse.PropertyDependenciesEntry]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.RegisterResourceResponse.PropertyDependenciesEntry](_l) {
  ...
  implicit class RegisterResourceResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceResponse]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.RegisterResourceResponse](_l) {
