...
object RegisterResourceOutputsRequest extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.RegisterResourceOutputsRequest] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.resource.ResourceProto.javaDescriptor.getMessageTypes().get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.resource.ResourceProto.scalaDescriptor.messages(6)
  ...
  implicit class RegisterResourceOutputsRequestLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.RegisterResourceOutputsRequest]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.RegisterResourceOutputsRequest](_l) {
