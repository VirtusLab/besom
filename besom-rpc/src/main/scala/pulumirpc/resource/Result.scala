...
object Result extends _root_.scalapb.GeneratedEnumCompanion[Result] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = pulumirpc.resource.ResourceProto.javaDescriptor.getEnumTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = pulumirpc.resource.ResourceProto.scalaDescriptor.enums(0)
}