...
/** @param properties
  ...
  */
@SerialVersionUID(0L)
final case class TransformResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[TransformResponse] {
    @transient
    ...
    def clearProperties: TransformResponse = copy(properties = _root_.scala.None)
    def withProperties(__v: com.google.protobuf.struct.Struct): TransformResponse = copy(properties = Option(__v))
    ...
    def clearOptions: TransformResponse = copy(options = _root_.scala.None)
    def withOptions(__v: pulumirpc.resource.TransformResourceOptions): TransformResponse = copy(options = Option(__v))
    ...
    def companion: pulumirpc.resource.TransformResponse.type = pulumirpc.resource.TransformResponse
    // @@protoc_insertion_point(GeneratedMessage[pulumirpc.TransformResponse])
}

object TransformResponse extends scalapb.GeneratedMessageCompanion[pulumirpc.resource.TransformResponse] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[pulumirpc.resource.TransformResponse] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): pulumirpc.resource.TransformResponse = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[pulumirpc.resource.TransformResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      pulumirpc.resource.TransformResponse(
        ...
        options = __fieldsMap.get(scalaDescriptor.findFieldByNumber(2).get).flatMap(_.as[_root_.scala.Option[pulumirpc.resource.TransformResourceOptions]])
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.resource.ResourceProto.javaDescriptor.getMessageTypes().get(11)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.resource.ResourceProto.scalaDescriptor.messages(11)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[?] = {
    var __out: _root_.scalapb.GeneratedMessageCompanion[?] = null
    (__number: @_root_.scala.unchecked) match {
      case 1 => __out = com.google.protobuf.struct.Struct
      case 2 => __out = pulumirpc.resource.TransformResourceOptions
    }
    __out
  }
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[? <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[?] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = pulumirpc.resource.TransformResponse(
    properties = _root_.scala.None,
    options = _root_.scala.None
  )
  implicit class TransformResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.resource.TransformResponse]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.resource.TransformResponse](_l) {
  ...
  ): _root_.pulumirpc.resource.TransformResponse = _root_.pulumirpc.resource.TransformResponse(
    properties,
    options
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[pulumirpc.TransformResponse])
}
