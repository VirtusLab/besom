...
object PluginInfo extends scalapb.GeneratedMessageCompanion[pulumirpc.plugin.PluginInfo] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = pulumirpc.plugin.PluginProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = pulumirpc.plugin.PluginProto.scalaDescriptor.messages(0)
  ...
  implicit class PluginInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, pulumirpc.plugin.PluginInfo]) extends _root_.scalapb.lenses.MessageLens[UpperPB, pulumirpc.plugin.PluginInfo](_l) {
