...
* **[Examples](https://github.com/VirtusLab/besom/tree/v0.5.0/examples)**: Browse Scala examples across many clouds and scenarios including containers, serverless,
  and infrastructure.
...
[examples](https://github.com/VirtusLab/besom/tree/v0.5.0/examples),
...
//> using dep "org.virtuslab::besom-aws:6.31.0-core.0.5"
