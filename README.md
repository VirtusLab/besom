...
* **[Examples](https://github.com/VirtusLab/besom/tree/v0.4.0/examples)**: Browse Scala examples across many clouds and scenarios including containers, serverless,
  and infrastructure.
...
3. **Install Scala Language Plugin in Pulumi**:
    ...
    ```bash
    pulumi plugin install language scala 0.4.0 --server github://api.github.com/VirtusLab/besom
    ```
...
4. **Create a new project**:
   ...
   You can get started with the `pulumi new` command:
    ...
    ```
    ```bash
    pulumi new https://github.com/VirtusLab/besom/tree/v0.4.0/templates/aws
    ```
...
[examples](https://github.com/VirtusLab/besom/tree/v0.4.0/examples),
...
```scala
//> using scala "3.3.1"
//> using plugin "org.virtuslab::besom-compiler-plugin:0.4.0"
//> using dep "org.virtuslab::besom-core:0.4.0"
//> using dep "org.virtuslab::besom-aws:6.31.0-core.0.4"
