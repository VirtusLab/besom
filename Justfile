...
compile-cats:
	scala-cli compile besom-cats {{scala-cli-main-options-cats}}

# Compiles besom zio extension
compile-zio:
	scala-cli compile besom-zio {{scala-cli-main-options-zio}}
...
publish-local-core:
  scala-cli publish local core --project-version {{besom-version}} --doc=false

# Publishes locally besom cats-effect extension
publish-local-cats:
	scala-cli publish local besom-cats {{ scala-cli-main-options-cats }} --project-version {{besom-version}} --doc=false

# Publishes locally besom zio extension
publish-local-zio:
	scala-cli publish local besom-zio {{ scala-cli-main-options-zio }} --project-version {{besom-version}} --doc=false
...
publish-local-compiler-plugin:
	scala-cli publish local compiler-plugin --project-version {{besom-version}} --doc=false
...
publish-maven-provider-sdk schema-name schema-version:
	scala-cli --power publish {{codegen-output-dir}}/{{schema-name}}/{{schema-version}} {{publish-maven-auth-options}} --doc=false
