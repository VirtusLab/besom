...
# Cleans everything
clean-all: clean-json clean-model clean-sdk clean-auto clean-out clean-compiler-plugin clean-codegen clean-scripts clean-test-integration clean-cfg clean-test-templates clean-test-examples clean-test-markdown

# Compiles everything
compile-all: compile-json compile-model compile-sdk compile-auto compile-codegen compile-scripts compile-compiler-plugin build-language-plugin
...
publish-local-all: publish-local-json publish-local-model publish-local-sdk publish-local-auto publish-local-codegen publish-local-scripts install-language-plugin

# Publishes everything to Maven
# TODO add publish-maven-auto once stable
publish-maven-all: publish-maven-json publish-maven-model publish-maven-sdk publish-maven-codegen publish-maven-scripts
